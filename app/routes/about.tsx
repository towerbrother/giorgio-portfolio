        ...
        <div className="flex flex-col xl:flex-row justify-center xl:justify-start align-start xl:align-top gap-6 xl:gap-12">
          <div>
            <p className="text-light-gray text-md lg:text-lg xl:text-xl max-w-xl md:max-w-2xl mb-3 lg:mb-5">
              Hello! My name is Giorgio. I'm a father, husband, son, friend, and
              a passionate software engineer. I find immense satisfaction in
              solving problems and witnessing my work positively impact
            ...
            <p className="text-light-gray text-md lg:text-lg xl:text-xl max-w-xl md:max-w-2xl mb-3 lg:mb-5">
              ...
              practical, and directly involved in creating solutions to
              problems. I'm a self-starter, dedicated to continually acquiring
              new skills while refining my existing one.
            </p>
            <p className="text-light-gray text-md lg:text-lg xl:text-xl max-w-xl md:max-w-2xl mb-3 lg:mb-5">
            ...
            <ul className="flex text-light-gray text-sm md:text-md gap-6">
              <div>
                ...
                <li className="list-disc list-inside mb-2 md:mb-3">Vue</li>
              </div>
              <div>
                <li className="list-disc list-inside mb-2 md:mb-3">NextJS</li>
                <li className="list-disc list-inside mb-2 md:mb-3">Nuxt3</li>
                <li className="list-disc list-inside mb-2 md:mb-3">NestJS</li>
                <li className="list-disc list-inside mb-2 md:mb-3">NodeJS</li>
              </div>
              <div>

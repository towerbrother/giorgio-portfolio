    ...
    <div className="flex flex-col justify-start xl:ml-[5vw]">
      <div className="mt-[10vh] md:mt-[20vh]">
        ...
        <p className="text-light-gray text-md md:text-xl max-w-sm md:max-w-lg">
          I’m a software engineer specialising in building reliable and user
          friendly digital experiences. Currently, I’m focusing on business
          building and innovation at{" "}
          <a

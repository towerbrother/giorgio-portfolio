...
export default function Index() {
  return (
    <>
      ...
      <Link
        to='/about'
        className='max-w-max my-6 lg:my-12 bg-transparent text-secondary border-2 border-solid border-secondary z-30 transition-all duration-200 ease-in-out text-xl py-2 px-3 hover:bg-secondary hover:text-primary'
      >
        About Me
      </Link>
    </>
